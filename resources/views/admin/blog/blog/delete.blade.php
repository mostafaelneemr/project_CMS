   ...
   <div class="modal-dialog">
       <div class="modal-content">
           <div class="modal-header">
               <h5 class="modal-title" id="exampleModalLabel">Delete one blog section</h5>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                   <span aria-hidden="true">&times;</span>
               </button>
           </div>
           <div class="modal-body">
               <form action="{{route('blog-section.destroy','test')}}" method="post">
                   @method('DELETE')
                   @csrf
                   ...
                   <div class="row">
                       <div class="col">
                        <label class="text-danger h6">Are you sure delete this blog section?</label>
