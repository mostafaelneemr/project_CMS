                        ...
                        <div class="col-md-12 mb-30">
                            <div class="card card-statistics h-100">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col mb-3">
                                            @if (\App\Models\backend\home\slider::where('slider_type', 'contact')->count() == 0)
                                                <a href="{{route('contact-slider.create')}}" class="btn btn-success" role="button" aria-pressed="true">create</a> 
                                            @endif
                                        </div>
                                            ...
                                            @foreach($sliders as $slider)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button class="btn btn-danger btn-sm" data-cont_id="{{$slider->id}}"  data-toggle="modal" 
                                                            data-target="#deletedcont"><i class="fa fa-trash"  title="Delete"></i></button>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                ...
                                @include('admin.email.slider.delete')
                            </div>
                        </div>
                    </div>
                </div>
...
@section('js')
<script>
    $('#deletedcont').on('show.bs.modal', function (event) {
