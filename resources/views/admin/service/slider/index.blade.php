    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col mb-3">
                        @if (\App\Models\backend\home\slider::where('slider_type', 'service')->count() == 0)
                            <a href="{{route('service-slider.create')}}" class="btn btn-success" role="button" aria-pressed="true">create</a> 
                        @endif
                    </div>
                </div>
                @endcan
            ...
            @include('admin.service.slider.delete')
        </div>
    </div>
</div>
